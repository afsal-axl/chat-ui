<script lang="ts">
	...
	import { saveOutput } from "$lib/stores/saveOutput";
	...
	// let webSearchParameters:webSearchParameters;
		...
		<div class="w-full">
			<div class="flex w-full pb-3">
				{#if $page.data.settings?.searchEnabled && !assistant}
					<Button label="Actions" onClick={handleButtonClick} />
					<Popup show={showPopup} close={closePopup}>
						<ToggleButton name={"Search Web"} propToggle={webSearchParameters} />
						<ToggleButton name={"Save Output"} propToggle={saveOutput} />
